...
tar xf /DEngine/desdk/archive/$HWPLAT/file/images.tar.bz2 -C /DEngine/desdk/archive/$HWPLAT/file/
/DEngine/desdk/platform/${TARGET_TYPE}_${TARGET_OS}-${TARGET_CPU}/bin/desdk download -n ${DEEPEYE_NUM} -b desdk -f /DEngine/desdk/archive/$HWPLAT/file/firmware/config.ini -s 0
