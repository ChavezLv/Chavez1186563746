...
/DEngine/desdk/platform/${TARGET_TYPE}_${TARGET_OS}-${TARGET_CPU}/bin/desdk download -n ${DEEPEYE_NUM} -b desdk -f /DEngine/desdk/archive/$HWPLAT/file/config_nand.ini