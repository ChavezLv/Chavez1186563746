...
if __name__ == "__main__":
    ...
    net_file = "/DEngine/model/dp1000/caffe_squeezenet_v1.1/net.bin"
    model_file = "/DEngine/model/dp1000/caffe_squeezenet_v1.1/model.bin"
    img_dir = "/DEngine/data/datasets/ILSVRC2012/ILSVRC2012_img_val"
    # 设置模型输入尺寸
    size = 224
    # 配置resize_shape到模型输入大小，如果模型配置了resize，可以配置None
