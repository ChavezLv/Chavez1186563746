...
function(detect_cuDNN)
  set(CUDNN_ROOT "/usr/local/cuda/lib64/" CACHE PATH "CUDNN root folder")
...
set(CUDA_gpu_detect_output "")
  ...
  if(NOT CUDA_gpu_detect_output)
    message(WARNING "Automatic GPU detection failed. Building for all known architectures (${known_gpu_archs}).")
...
function(select_nvcc_arch_flags out_variable)
  ...
  elseif("${CUDA_ARCH_LIST}" STREQUAL "Auto" OR "${CUDA_ARCH_LIST}" STREQUAL "")
    set(known_gpu_archs ${CUDA_COMMON_GPU_ARCHITECTURES})
    detect_installed_gpus(CUDA_ARCH_LIST)
  ...
  if(${CUDA_VERSION} EQUAL 8.0 OR ${CUDA_VERSION} EQUAL 9.1)
  set(cuda_arch_bin 60 61)
  else()
  set(cuda_arch_bin 60 61 70 75)
