...
#ifndef ARCTERN_BASE_UNITTEST_ALGORITHMS_FACEPOSE_TRT_TRTGROUNDTRUTH_H_
#define ARCTERN_BASE_UNITTEST_ALGORITHMS_FACEPOSE_TRT_TRTGROUNDTRUTH_H_
#include "../groundtruth.h"
#include "gtest/gtest.h"
#include "include/autoTime.h"
#include "UnitTest/UnitTestBase/trt/TrtUtils.h"

class TrtFacePoseUnittest : public FacePoseUnittest  {
 public:
  TrtFacePoseUnittest(const TrtTestParam& parameter);
  ~TrtFacePoseUnittest();
