...
#ifndef ARCTERN_BASE_UNITTEST_ALGORITHMS_FACEJOY_TRT_TRTGROUNDTRUTH_H_
#define ARCTERN_BASE_UNITTEST_ALGORITHMS_FACEJOY_TRT_TRTGROUNDTRUTH_H_
#include "../groundtruth.h"
#include "gtest/gtest.h"
#include "include/autoTime.h"
#include "UnitTest/UnitTestBase/trt/TrtUtils.h"

class TrtFaceJoyUnittest : public FaceJoyUnittest  {
 public:
  TrtFaceJoyUnittest(const TrtTestParam& parameter);
  ~TrtFaceJoyUnittest();
