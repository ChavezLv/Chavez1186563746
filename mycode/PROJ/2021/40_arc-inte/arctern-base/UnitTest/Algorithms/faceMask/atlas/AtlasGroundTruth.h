...
#ifndef ARCTERN_BASE_UNITTEST_ALGORITHMS_FACEMASK_ATLAS_ATLASGROUNDTRUTH_H_
#define ARCTERN_BASE_UNITTEST_ALGORITHMS_FACEMASK_ATLAS_ATLASGROUNDTRUTH_H_
#include "../groundtruth.h"
#include "gtest/gtest.h"
#include "include/autoTime.h"
#include "UnitTest/UnitTestBase/atlas/AtlasUtils.h"

class AtlasFaceMaskUnittest : public FaceMaskUnittest  {
 public:
  AtlasFaceMaskUnittest(const AtlasTestParam& parameter);
  ~AtlasFaceMaskUnittest();
