...
TEST(GarbageOverflow, TRT_video000) {

  TrtTestParam parameter;
  parameter.ymlGroundTruth = getDir() + "results_arcterncpp/LINUX_MXNET_CPU/garbage_overflow-det-f32-d-0.1.0-rc.yml";
  parameter.ymlInput = "";
  parameter.imgPath = getDir() + "data/detect_garbage_overflow/";

  parameter.modelPath = ARCTERN_PROJECT_PATH + string("/../arctern-models/develop/unclassified/garbage_overflow-det-f32-d-0.1.0.bin");
  ...
  TrtGarbageOverflowUnittest unittest(parameter);
  unittest.test();
}
TEST(GarbageOverflow, TRT_onnx) {

  TrtTestParam parameter;
  parameter.ymlGroundTruth = getDir() + "results_arcterncpp/LINUX_MXNET_CPU/garbage_overflow-det-f32-d-0.1.0-rc.yml";
  parameter.ymlInput = "";
  parameter.imgPath = getDir() + "/data/detect_bargage_overflow/";
