...
#ifndef ARCTERN_BASE_SRC_ATLASLINUXALGORITHMS_VEHICLECYCLEATTR_ATLASVEHICLECYCLEATTRIMPL_H_
#define ARCTERN_BASE_SRC_ATLASLINUXALGORITHMS_VEHICLECYCLEATTR_ATLASVEHICLECYCLEATTRIMPL_H_

#include "src/Algorithms/vehicleCycleAttr/vehicleCycleAttr.h"
#include "src/Base/atlas/ArcternAlgorithmEx.h"
namespace arctern {
class AtlasVehicleCycleAttrImpl : public ArcternAlgorithmEx {
 public:
  AtlasVehicleCycleAttrImpl();
  ~AtlasVehicleCycleAttrImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ATLASLINUXALGORITHMS_VEHICLECYCLEATTR_ATLASVEHICLECYCLEATTRIMPL_H_
