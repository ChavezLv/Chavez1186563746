...
#include "atlasVehicleCycleFeatImpl.h"
...
AtlasVehicleCycleFeatImpl::AtlasVehicleCycleFeatImpl(){
...
ErrorType AtlasVehicleCycleFeatImpl::GetModelsConfigInfo(const TrtModels* models){
  return ERR_SUCCESS;
}

ErrorType AtlasVehicleCycleFeatImpl::LocalPostProcess(const RunParameter *p, int startId, int endId,
...
ErrorType AtlasVehicleCycleFeatImpl::LocalPreProcess(std::vector<DvppDataInfo>& vInputInfo,
...
cv::Rect AtlasVehicleCycleFeatImpl::LocalGetROI(const RunParameter *p, int idx){
