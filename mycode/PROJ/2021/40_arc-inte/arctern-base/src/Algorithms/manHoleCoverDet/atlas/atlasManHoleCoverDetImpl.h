...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_MANHOLECOVERDET_ATLASMANHOLECOVERDETIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_MANHOLECOVERDET_ATLASMANHOLECOVERDETIMPL_H_
...
namespace arctern {
class AtlasManHoleCoverDetImpl : public ArcternAlgorithmEx {
 public:
  AtlasManHoleCoverDetImpl();
  ~AtlasManHoleCoverDetImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_MANHOLECOVERDET_ATLASMANHOLECOVERDETIMPL_H_
