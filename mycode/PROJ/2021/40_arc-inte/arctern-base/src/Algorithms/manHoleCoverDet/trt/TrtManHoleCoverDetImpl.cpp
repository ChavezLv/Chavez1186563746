...
#include "TrtManHoleCoverDetImpl.h"

namespace arctern {

TrtManHoleCoverDetectImpl::TrtManHoleCoverDetectImpl() {
...
ErrorType TrtManHoleCoverDetectImpl::LocalPostProcess(const RunParameter *p, \
...
void TrtManHoleCoverDetectImpl::InitPreprocessorRunParam(NppPreprocessorRunPt *runParm){
...
ErrorType TrtManHoleCoverDetectImpl::GetModelsConfigInfo(const MxnetModels *models) {
  assert(models);
...
void TrtManHoleCoverDetectImpl::InitPreprocessorParam(){
