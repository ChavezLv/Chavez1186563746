...
#include "TrtCargoIllegalDetectImpl.h"

namespace arctern {

TrtCargoIllegalDetectectImpl::TrtCargoIllegalDetectectImpl() {
...
ErrorType TrtCargoIllegalDetectectImpl::LocalPostProcess(const RunParameter *p, \
                            int startId, int endId,vector<arctern::OutputTensor<float>> &outputs){
    

  auto r = dynamic_cast<CargoIllegalDetectResult*>(m_pResult);
...
void TrtCargoIllegalDetectectImpl::InitPreprocessorRunParam(NppPreprocessorRunPt *runParm){
...
ErrorType TrtCargoIllegalDetectectImpl::GetModelsConfigInfo(const MxnetModels *models) {
  assert(models);
...
void TrtCargoIllegalDetectectImpl::InitPreprocessorParam(){
