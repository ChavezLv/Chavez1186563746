...
#ifndef __ARCTERN_BASE_TRTCARGOILLEGALDETECTIMPL_H__
#define __ARCTERN_BASE_TRTCARGOILLEGALDETECTIMPL_H__
...
class TrtCargoIllegalDetectectImpl : public ArcternAlgorithmEx {
 public:
  TrtCargoIllegalDetectectImpl();

  virtual ~TrtCargoIllegalDetectectImpl();
...
#endif //__ARCTERN_BASE_TRTCARGOILLEGALDETECTIMPL_H__
