...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_RUBBISHDETECTTINY_ATLASRUBBISHDETECTTINYIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_RUBBISHDETECTTINY_ATLASRUBBISHDETECTTINYIMPL_H_
...
namespace arctern {
class AtlasRubbishDetectTinyImpl : public ArcternAlgorithmEx {
 public:
  AtlasRubbishDetectTinyImpl();
  ~AtlasRubbishDetectTinyImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_RUBBISHDETECTTINY_ATLASRUBBISHDETECTTINYIMPL_H_
