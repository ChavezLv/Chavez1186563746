...
RubbishDetectTinyImpl::RubbishDetectTinyImpl() : m_bNormalized(true) {
}

RubbishDetectTinyImpl::~RubbishDetectTinyImpl() {}

int RubbishDetectTinyImpl::GetConfigInfo(arctern::MxnetModel *model) {
  // todo check
...
ErrorType
RubbishDetectTinyImpl::LocalPostProcess(const RunParameter *p, int startId, int endId,
                                 std::vector<arctern::Tensor<float>> &outputs) {
  auto r = dynamic_cast<RubbishDetectTinyResult *>(result_);
...
void RubbishDetectTinyImpl::InitPreprocessorParam() {
...
void RubbishDetectTinyImpl::InitPreprocessorRunParam(OpencvPreprocessorRunRt *runParm) {
