...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_RIVERFLOAT_ATLASRIVERFLOATYIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_RIVERFLOAT_ATLASRIVERFLOATYIMPL_H_
...
namespace arctern {
class AtlasRiverFloatImpl : public ArcternAlgorithmEx {
 public:
  AtlasRiverFloatImpl();
  ~AtlasRiverFloatImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_RIVERFLOAT_ATLASRIVERFLOATYIMPL_H_
