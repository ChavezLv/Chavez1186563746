...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_ADVERTISEMENTDET_ATLASADVERTISEMENTDETIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_ADVERTISEMENTDET_ATLASADVERTISEMENTDETIMPL_H_
...
namespace arctern {
class AtlasAdvertisementDetImpl : public ArcternAlgorithmEx {
 public:
  AtlasAdvertisementDetImpl();
  ~AtlasAdvertisementDetImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_ADVERTISEMENTDET_ATLASADVERTISEMENTDETIMPL_H_
