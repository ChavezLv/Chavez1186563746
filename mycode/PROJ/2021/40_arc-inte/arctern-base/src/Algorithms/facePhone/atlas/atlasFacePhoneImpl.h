...
#ifndef ARCTERN_BASE_SRC_ATLASLINUXALGORITHMS_FACEPHONE_ATLASFACEPHONEIMPL_H_
#define ARCTERN_BASE_SRC_ATLASLINUXALGORITHMS_FACEPHONE_ATLASFACEPHONEIMPL_H_

#include "src/Algorithms/facePhone/facePhone.h"
#include "src/Base/atlas/ArcternAlgorithmEx.h"
namespace arctern {
class AtlasFacePhoneImpl : public ArcternAlgorithmEx {
 public:
  AtlasFacePhoneImpl();
  ~AtlasFacePhoneImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ATLASLINUXALGORITHMS_FACEPHONE_ATLASFACEPHONEIMPL_H_
