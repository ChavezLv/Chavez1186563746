...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_FIREDET_ATLASFIREDETIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_FIREDET_ATLASFIREDETIMPL_H_
...
namespace arctern {
class AtlasFireDetImpl : public ArcternAlgorithmEx {
 public:
  AtlasFireDetImpl();
  ~AtlasFireDetImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_FIREDET_ATLASFIREDETIMPL_H_
