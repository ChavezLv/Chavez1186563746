...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_OBJECTDET_ATLASOBJECTDETIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_OBJECTDET_ATLASOBJECTDETIMPL_H_
...
namespace arctern {
class AtlasObjectDetImpl : public ArcternAlgorithmEx {
 public:
  AtlasObjectDetImpl();
  ~AtlasObjectDetImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_OBJECTDET_ATLASOBJECTDETIMPL_H_
