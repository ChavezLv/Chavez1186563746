...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_ILLEGALACCUMULATION_ATLASILLEGALACCUMULATIONIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_ILLEGALACCUMULATION_ATLASILLEGALACCUMULATIONIMPL_H_
...
namespace arctern {
class AtlasIllegalAccumulationImpl : public ArcternAlgorithmEx {
 public:
  AtlasIllegalAccumulationImpl();
  ~AtlasIllegalAccumulationImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_ILLEGALACCUMULATION_ATLASILLEGALACCUMULATIONIMPL_H_
