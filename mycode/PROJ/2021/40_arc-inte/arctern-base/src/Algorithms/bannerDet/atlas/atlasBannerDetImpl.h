...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_BANNERDET_ATLASBANNERDETIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_BANNERDET_ATLASBANNERDETIMPL_H_
...
namespace arctern {
class AtlasBannerDetImpl : public ArcternAlgorithmEx {
 public:
  AtlasBannerDetImpl();
  ~AtlasBannerDetImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_BANNERDET_ATLASBANNERDETIMPL_H_
