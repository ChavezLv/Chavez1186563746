...
#ifndef __ARCTERN_BASE_TRTBANNERDETIMPL_H__
#define __ARCTERN_BASE_TRTBANNERDETIMPL_H__
...
class TrtBannerDetectImpl : public ArcternAlgorithmEx {
 public:
  TrtBannerDetectImpl();

  virtual ~TrtBannerDetectImpl();
...
#endif //__ARCTERN_BASE_TRTBANNERDETIMPL_H__
