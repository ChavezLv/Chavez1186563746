...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_MESSYMATERIALS_ATLASMESSYMATERIALSIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_MESSYMATERIALS_ATLASMESSYMATERIALSIMPL_H_
...
namespace arctern {
class AtlasMessyMaterialsImpl : public ArcternAlgorithmEx {
 public:
  AtlasMessyMaterialsImpl();
  ~AtlasMessyMaterialsImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_MESSYMATERIALS_ATLASMESSYMATERIALSIMPL_H_
