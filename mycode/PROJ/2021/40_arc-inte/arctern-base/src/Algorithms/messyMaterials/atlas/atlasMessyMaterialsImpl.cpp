...
#include "atlasMessyMaterialsImpl.h"
...
AtlasMessyMaterialsImpl::AtlasMessyMaterialsImpl(){
...
ErrorType AtlasMessyMaterialsImpl::GetModelsConfigInfo(const TrtModels* models){
  assert(models);
...
ErrorType AtlasMessyMaterialsImpl::LocalPostProcess(const RunParameter *p, int startId, int endId,
std::vector<std::vector<float>> &outputs) {
  
  auto r = dynamic_cast<MessyMaterialsResult *>(m_pResult);
...
ErrorType AtlasMessyMaterialsImpl::LocalPreProcess(std::vector<DvppDataInfo>& vInputInfo,
