 ...
 ****************************************************************************/
#include "rknnFacialLandmarkImpl.h"

using arctern::ErrorType;
using arctern::RknnFacialLandmarkImpl;

RknnFacialLandmarkImpl::RknnFacialLandmarkImpl() : FacialLandmarkImpl() {
  isNormaliized_ = false;
  dstImageFormatForForward_ = ARCTERN_IMAGE_FORMAT_BGR888;
}

RknnFacialLandmarkImpl::~RknnFacialLandmarkImpl() {
}

ErrorType RknnFacialLandmarkImpl::Init(const InitParameter *p) {
...
ErrorType RknnFacialLandmarkImpl::LocalPostProcess(const RunParameter *p,
                                                   int startId,
                                                   int endId,
