...
#include "atlasLoessDetectTinyImpl.h"
...
AtlasLoessDetectTinyImpl::AtlasLoessDetectTinyImpl(){
...
ErrorType AtlasLoessDetectTinyImpl::GetModelsConfigInfo(const TrtModels* models){
  assert(models);
...
ErrorType AtlasLoessDetectTinyImpl::LocalPostProcess(const RunParameter *p, int startId, int endId,
std::vector<std::vector<float>> &outputs) {
  
  auto r = dynamic_cast<LoessDetectTinyResult *>(m_pResult);
...
ErrorType AtlasLoessDetectTinyImpl::LocalPreProcess(std::vector<DvppDataInfo>& vInputInfo,
