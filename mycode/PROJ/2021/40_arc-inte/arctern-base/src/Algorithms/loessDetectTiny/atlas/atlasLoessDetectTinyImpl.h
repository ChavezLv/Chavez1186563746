...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_LOESSETECTTINY_ATLASLOESSDETECTTINYIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_LOESSETECTTINY_ATLASLOESSDETECTTINYIMPL_H_
...
namespace arctern {
class AtlasLoessDetectTinyImpl : public ArcternAlgorithmEx {
 public:
  AtlasLoessDetectTinyImpl();
  ~AtlasLoessDetectTinyImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_LOESSETECTTINY_ATLASLOESSDETECTTINYIMPL_H_
