...
#include "atlasFaceDetectTinyImpl.h"
...
AtlasFaceDetectTinyImpl::AtlasFaceDetectTinyImpl(){
...
ErrorType AtlasFaceDetectTinyImpl::GetModelsConfigInfo(const TrtModels* models){
  assert(models);
...
ErrorType AtlasFaceDetectTinyImpl::LocalPostProcess(const RunParameter *p, int startId, int endId,
...
ErrorType AtlasFaceDetectTinyImpl::LocalPreProcess(std::vector<DvppDataInfo>& vInputInfo,
