...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_FACEDETECTTINY_ATLASFACEDETECTTINYIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_FACEDETECTTINY_ATLASFACEDETECTTINYIMPL_H_
...
namespace arctern {
class AtlasFaceDetectTinyImpl : public ArcternAlgorithmEx {
 public:
  AtlasFaceDetectTinyImpl();
  ~AtlasFaceDetectTinyImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_FACEDETECTTINY_ATLASFACEDETECTTINYIMPL_H_
