...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_HANGSTREETDET_ATLASHANGSTREETDETIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_HANGSTREETDET_ATLASHANGSTREETDETIMPL_H_
...
namespace arctern {
class AtlasHangStreetDetImpl : public ArcternAlgorithmEx {
 public:
  AtlasHangStreetDetImpl();
  ~AtlasHangStreetDetImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_HANGSTREETDET_ATLASHANGSTREETDETIMPL_H_
