...
#ifndef ARCTERN_BASE_TRTFACEMASKIMPL_H
#define ARCTERN_BASE_TRTFACEMASKIMPL_H
...
using namespace std;
namespace arctern {
class TrtFaceMaskImpl : public ArcternAlgorithmEx {
 public:
  TrtFaceMaskImpl();

  virtual ~TrtFaceMaskImpl();
...
#endif //ARCTERN_BASE_TRTFACEMASKIMPL_H
