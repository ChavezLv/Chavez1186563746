...
#ifndef ARCTERN_BASE_SRC_ALGORITHMS_GARBAGEOVERFLOW_ATLASGARBAGEOVERFLOWIMPL_H_
#define ARCTERN_BASE_SRC_ALGORITHMS_GARBAGEOVERFLOW_ATLASGARBAGEOVERFLOWIMPL_H_
...
namespace arctern {
class AtlasGarbageOverflowImpl : public ArcternAlgorithmEx {
 public:
  AtlasGarbageOverflowImpl();
  ~AtlasGarbageOverflowImpl() override ;
...
#endif //ARCTERN_BASE_SRC_ALGORITHMS_GARBAGEOVERFLOW_ATLASGARBAGEOVERFLOWIMPL_H_
