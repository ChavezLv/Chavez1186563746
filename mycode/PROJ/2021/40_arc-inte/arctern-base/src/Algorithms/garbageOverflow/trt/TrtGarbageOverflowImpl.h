...
#ifndef __ARCTERN_BASE_SRC_ALGORITHMS_GARBAGEOVERFLOW_TRT_TRTGARBAGEOVERFLOWIMPL_H__
#define __ARCTERN_BASE_SRC_ALGORITHMS_GARBAGEOVERFLOW_TRT_TRTGARBAGEOVERFLOWIMPL_H__
...
class TrtGarbageOverflowImpl : public ArcternAlgorithmEx {
 public:
  TrtGarbageOverflowImpl();

  virtual ~TrtGarbageOverflowImpl() override;
...
#endif //__ARCTERN_BASE_SRC_ALGORITHMS_GARBAGEOVERFLOW_TRT_TRTGARBAGEOVERFLOWIMPL_H__
