...
#include "TrtGarbageOverflowImpl.h"

namespace arctern {

TrtGarbageOverflowImpl::TrtGarbageOverflowImpl() {
...
ErrorType TrtGarbageOverflowImpl::LocalPostProcess(const RunParameter *p, \
...
void TrtGarbageOverflowImpl::InitPreprocessorRunParam(NppPreprocessorRunPt *runParm){
...
ErrorType TrtGarbageOverflowImpl::GetModelsConfigInfo(const MxnetModels *models) {
  assert(models);
...
void TrtGarbageOverflowImpl::InitPreprocessorParam(){
