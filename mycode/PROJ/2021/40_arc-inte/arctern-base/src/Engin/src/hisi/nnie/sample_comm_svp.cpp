...
HI_U32 u32Height,HI_U32 u32AddrOffset)
{
	...
	case SVP_IMAGE_TYPE_S8C1:
      ...
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 1 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
	...
	case SVP_IMAGE_TYPE_YUV420SP:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 2 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
			pstImg->au64PhyAddr[0] += u32AddrOffset;
			pstImg->au64VirAddr[0] += u32AddrOffset;
	...
	case SVP_IMAGE_TYPE_YUV420P:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 3 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
	...
	case SVP_IMAGE_TYPE_YUV422P:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 4 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
	...
	case SVP_IMAGE_TYPE_S8C2_PACKAGE:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 5 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
	...
	case SVP_IMAGE_TYPE_S8C2_PLANAR:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 6 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
	...
	case SVP_IMAGE_TYPE_U16C1:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 7 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
			pstImg->au64PhyAddr[0] += u32AddrOffset;
			pstImg->au64VirAddr[0] += u32AddrOffset;
		}
	...
	case SVP_IMAGE_TYPE_U8C3_PACKAGE:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 8 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
	...
	case SVP_IMAGE_TYPE_U8C3_PLANAR:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 9 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
	...
	case SVP_IMAGE_TYPE_U32C1:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 10 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
			pstImg->au64PhyAddr[0] += u32AddrOffset;
			pstImg->au64VirAddr[0] += u32AddrOffset;
		}
	...
	case SVP_IMAGE_TYPE_U64C1:
		{
            ...
            //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
      if (s32Ret != HI_SUCCESS) {
        std::cerr << "[SAMPLE_COMM_SVP_CreateImage::HI_MPI_SYS_MmzAlloc] 11 failed: " << std::hex << s32Ret << std::dec << std::endl;
      }
...
HI_VOID SAMPLE_COMM_SVP_DestroyImage(SVP_IMAGE_S *pstImg,HI_U32 u32AddrOffset)
{
    if (NULL != pstImg)
    {
       ...
       {
         (HI_VOID)HI_MPI_SYS_MmzFree(pstImg->au64PhyAddr[0] - u32AddrOffset, (void *) (pstImg->au64VirAddr[0] - u32AddrOffset));
       }
...
HI_S32 SAMPLE_COMM_SVP_CreateMemInfo(SVP_MEM_INFO_S *pstMemInfo,HI_U32 u32Size,HI_U32 u32AddrOffset)
{
    ...
    //SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret, s32Ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "Error(%#x):HI_MPI_SYS_MmzAlloc failed!\n", s32Ret);
  if (s32Ret != HI_SUCCESS) {
    std::cerr << "[SAMPLE_COMM_SVP_CreateMemInfo::HI_MPI_SYS_MmzAlloc] failed: " << std::hex << s32Ret << std::dec << std::endl;
  }
...
HI_VOID SAMPLE_COMM_SVP_DestroyMemInfo(SVP_MEM_INFO_S *pstMemInfo,HI_U32 u32AddrOffset)
{
    if (NULL != pstMemInfo)
    {
       ...
       {
         (HI_VOID)HI_MPI_SYS_MmzFree(pstMemInfo->u64PhyAddr - u32AddrOffset, (void *) (pstMemInfo->u64VirAddr - u32AddrOffset));
       }
...
HI_S32 SAMPLE_COMM_SVP_MallocMem(HI_CHAR *pszMmb, HI_CHAR *pszZone, HI_U64 *pu64PhyAddr, HI_VOID **ppvVirAddr, HI_U32 u32Size)
{
  ...
  if (s32Ret != HI_SUCCESS) {
    std::cerr << "[SAMPLE_COMM_SVP_MallocMem::HI_MPI_SYS_MmzAlloc] failed: " << std::hex << s32Ret << std::dec << std::endl;
  }
...
HI_S32 SAMPLE_COMM_SVP_MallocCached(HI_CHAR *pszMmb, HI_CHAR *pszZone,HI_U64 *pu64PhyAddr, HI_VOID **ppvVirAddr, HI_U32 u32Size)
{
  ...
  if (s32Ret != HI_SUCCESS) {
    std::cerr << "[SAMPLE_COMM_SVP_MallocCached::HI_MPI_SYS_MmzAlloc_Cached] failed: " << std::hex << s32Ret << std::dec << std::endl;
  }
