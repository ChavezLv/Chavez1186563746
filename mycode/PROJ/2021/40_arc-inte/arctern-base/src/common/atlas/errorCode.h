...
#ifndef ARCTERN_ERRORCODE_H
#define ARCTERN_ERRORCODE_H
...
// define the data tpye of error code
    enum {
        ...
        APP_ERR_DVPP_BASE + 12,       // DVPP: fail to create acldvppCreatePicDesc or fail to set acldvppCreatePicDesc
        APP_ERR_DVPP_CONFIG_FAIL = APP_ERR_DVPP_BASE +
                                   13,        // DVPP: fail to set dvpp configuration,such as resize configuration,crop configuration
    ...
    const std::string APP_ERR_COMMON_LOG_STRING[] = {
            ...
            [APP_ERR_COMM_NO_EXIST - APP_ERR_COMM_BASE] = "Object, file or other resource already doesn't exist",
    ...
    const std::string APP_ERR_QUEUE_LOG_STRING[] = {
            ...
            [APP_ERROR_QUEUE_FULL - APP_ERR_QUEUE_BASE] = "full queue",
    };

    const std::string APP_ERR_FACE_LOG_STRING[] = {
            [0] = "Placeholder",
            [APP_ERROR_FACE_WEB_USE_SYSTEM_ERROR - APP_ERROR_FACE_WEB_USE_BASE] = "system error",
            [APP_ERROR_FACE_WEB_USE_MUL_FACE - APP_ERROR_FACE_WEB_USE_BASE] = "multiple faces",
            [APP_ERROR_FACE_WEB_USE_REPEAT_REG - APP_ERROR_FACE_WEB_USE_BASE] = "repeat registration",
            [APP_ERROR_FACE_WEB_USE_PART_SUCCESS - APP_ERROR_FACE_WEB_USE_BASE] = "partial search succeeded",
            [APP_ERROR_FACE_WEB_USE_NO_FACE - APP_ERROR_FACE_WEB_USE_BASE] = "no face detected",
    };
