...
func SetComment()
        call setline(1,"/*================================================================")
        call append(line("."),   "*   Copyright (C) ".strftime("%Y")." anonymous All rights reserved.")
        call append(line(".")+1, "*   ")
        call append(line(".")+2, "*   @file       ：".expand("%:t"))
        call append(line(".")+3, "*   @author     ：anonymous")
...
func SetTitle()
        ...
        elseif &filetype == 'sh'
                ...
                call SetComment()
                if expand("%:e") == 'hpp'
                        call append(line(".")+10, "#ifndef __WD_".toupper(expand("%:t:r"))."_HPP__")
                        call append(line(".")+11, "#define __WD_".toupper(expand("%:t:r"))."_HPP__")
                        ...
                        call append(line(".")+20, "")
                        call append(line(".")+21, "namespace wd{")
                        call append(line(".")+22, "")
                        call append(line(".")+23, "}//end of namespace wd")
                        call append(line(".")+24, "")
                        call append(line(".")+25, "#endif //__WD_".toupper(expand("%:t:r"))."_HPP__")
                ...
                elseif &filetype == 'cpp'
                        ...
                        call append(line(".")+11, "")
                        call append(line(".")+12, "namespace wd{")
                        call append(line(".")+13, "")
                        call append(line(".")+14, "}//end of namespace wd")
                        call append(line(".")+15, "")
                endif
        endif
endfunc
