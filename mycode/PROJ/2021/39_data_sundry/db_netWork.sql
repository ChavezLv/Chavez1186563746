...
CREATE TABLE `DIR_INFO` (
  ...
  `dirName` char(20) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
...
INSERT INTO `DIR_INFO` VALUES (0,0,'home','2021-07-17 12:45:41',0),(7,0,'xiaobai','2021-07-17 12:52:25',25),(8,0,'123456','2021-07-17 15:48:17',33),(9,0,'xiaohei','2021-07-18 06:25:17',34),(10,0,'xiaohong','2021-07-18 07:32:45',35),(11,0,'alyu','2021-07-20 07:58:24',36),(12,0,'alyu01','2021-07-21 09:58:05',37);
...
CREATE TABLE `FILE_INFO` (
  ...
  `fileSize` mediumtext,
  `MD5` char(64) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
...
INSERT INTO `FILE_INFO` VALUES (1,'1024','1234',2),(2,'12','112',1);
...
INSERT INTO `LOG_OPERATION` VALUES (0,'logout','2021-07-18 12:44:59'),(0,'logout','2021-07-18 13:12:56'),(36,'user register','2021-07-20 07:58:24'),(36,'user load','2021-07-20 07:59:14'),(36,'user load','2021-07-20 08:13:06'),(36,'user load','2021-07-21 09:57:15'),(36,'user load','2021-07-21 09:57:31'),(37,'user register','2021-07-21 09:58:05'),(37,'user load','2021-07-21 09:58:14'),(37,'user load','2021-07-21 11:26:53');
...
CREATE TABLE `USER_FILE` (
  ...
  `fileName` char(64) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  `cTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  KEY `dirID` (`dirID`),
  KEY `userID` (`userID`),
  KEY `fileID` (`fileID`),
...
INSERT INTO `USER_INFO` VALUES (0,'0','0','0','0',0,0),(25,'xiaobai','Kf','S2DH6Wl0XXCu2','0',0,7),(33,'123456','r4','U3qGJIjdXLb12','0',0,8),(34,'xiaohei','a9','q3UJk14FL7pz.','0',0,9),(35,'xiaohong','ys','ANWItn1j7UIbw','0',0,10),(36,'alyu','$6$ZHslF96i','$6$ZHslF96i$1rfxBvI1YU3JWwCknfXvzSy6WPwHj6beWkXUPlUVaGjRBr2bqeMM1PzXBfTcLi7ZD3UVMhZOcdb9rNUihP.Fm/','0',0,11),(37,'alyu01','$6$3g74eKuu','$6$3g74eKuu$iFUNI6LDt4J9T0O2DWnkUidLqiBsk3uNZktxhoOvnwEMofDp33.Dhc6mF0auvBTeudGUmNdBKQ5Djg4qHkv.F.','0',0,12);
...
-- Dump completed on 2021-07-21 19:51:49
