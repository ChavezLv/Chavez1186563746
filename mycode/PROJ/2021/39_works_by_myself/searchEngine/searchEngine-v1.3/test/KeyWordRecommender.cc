...
#include "KeyWordRecommender.hpp"
...
KeyRecommender::KeyRecommender(const string &queryWord, Configuration &config)
...
string KeyRecommender::sub(string str, int start, int &flag, int end = -1)
{
